  ...
  useEffect(() => {
    const fetchTemplates = async () => {
      try {
        ...
        console.log("🚀 Plantillas cargadas desde el servidor:", data);
        setTemplates(data);
      } catch (error) {
    ...
    const fetchStatuses = async () => {
      try {
        ...
        console.log("🚀 Estados cargados desde el servidor:", data);
        setStatuses(data);
      } catch (error) {
    ...
    const fetchShifts = async () => {
      try {
        ...
        console.log("🚀 Turnos cargados desde el servidor:", data);
        setShifts(data);
      } catch (error) {
